  ...
  return (
    <div className="min-h-screen bg-[#f4f5fb] px-6 py-10">
      <div className="mx-auto max-w-md rounded-3xl border border-white/55 bg-white/40 p-6 shadow-[0_20px_60px_rgba(17,24,39,0.14)] backdrop-blur-2xl">
        ...
        <button
          className="mt-4 w-full rounded-xl border border-white/40 bg-[#FF5264]/95 px-4 py-2.5 text-sm font-medium text-white shadow-[0_8px_22px_rgba(255,82,100,0.45)]"
        ...
        {sent ? <div className="mt-3 text-sm text-emerald-600">Reset link sent (demo).</div> : null}
