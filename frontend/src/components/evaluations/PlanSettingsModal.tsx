...
import type { CreatePlanFormValues } from "@/components/evaluations/CreatePlanModal";
...
export function PlanSettingsModal({ open, onClose, initialValues, onSubmit, isSubmitting, errorMessage }: PlanSettingsModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Edit plan details">
