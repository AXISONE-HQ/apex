...
CREATE INDEX guardians_org_id_idx ON guardians (org_id);
CREATE INDEX guardians_org_name_idx ON guardians (org_id, last_name, first_name, created_at);
CREATE INDEX guardians_org_status_idx ON guardians (org_id, status);
